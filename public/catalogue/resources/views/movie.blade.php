...
<link href="../../public/css/boot.css" rel="stylesheet" type="text/css" media="all" />
                                                         ...
                                                         <div class="dd_left">
                                                             <ul>
                                                                 ...
                                                                 <li><i class="fas fa-heart"
                                                                         style="margin-top: 14px;"></i></li>
                                                                 <li><i class="fas fa-history"
                                                                         style="margin-top: 16px;"></i></li>
                                                                 <li><i class="fas fa-cog" style="margin-top: 16px;"></i>
                                                                 </li>
                                                                 <li><i class="fas fa-sign-out-alt"
                                                                         style="margin-top: 15px;"></i></li>
                                                             </ul>
                                                         </div>
                                                         <div class="dd_right categories"
