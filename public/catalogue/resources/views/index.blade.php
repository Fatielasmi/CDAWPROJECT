        ...
        <div class="headertop_desc">
            <div class="wrap">
                ...
                <div class="account_desc">
                    <ul>
                        <li><a a href="/connex" data-toggle="modal" data-target="#singInPage">Login</a></li>
                        <li><a href="/register" id="regist" class="text-right " data-toggle="modal"
                                data-target="#loginModal" style="padding-left: 18px;">Register</a></li>
                    ...
                    <div class="categories">
                        <ul>
                            ...
                            <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0"
                                style="padding-top: 8px; padding-bottom: 8px;"><strong><u> Categories</u></strong></p>
